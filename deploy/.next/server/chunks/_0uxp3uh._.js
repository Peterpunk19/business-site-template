module.exports = [
  ...
  (A) => {
    ...
    A.i(52474);
    var c = A.i(220);
    let I = new w.AppRouteRouteModule({
        definition: {
      ...
      { workAsyncStorage: Q, workUnitAsyncStorage: E, serverHooks: d } = I;
    async function M(A, w, P) {
      (P.requestMeta && (0, e.setRequestMeta)(A, P.requestMeta),
        I.isDev &&
          (0, e.addRequestMeta)(A, "devRequestTimingInternalsEnd", process.hrtime.bigint()));
      let Q = "/favicon.ico/route";
      Q = Q.replace(/\/index$/, "") || "/";
      let E = await I.prepare(A, w, { srcPage: Q, multiZoneDraftMode: !1 });
      if (!E)
        return (
          (w.statusCode = 400),
          w.end("Bad Request"),
      ...
      let {
        ...
        S = (0, a.normalizeAppPath)(Q),
        j = !!(R.dynamicRoutes[S] || R.routes[O]),
        V = async () => (
          (null == H ? void 0 : H.render404)
            ? await H.render404(A, w, p, !1)
      ...
      if (j && !v) {
        let A = !!R.routes[O],
          w = R.dynamicRoutes[S];
        if (w && !1 === w.fallback && !A) {
          if (f.adapterPath) return await V();
          throw new C.NoFallbackError();
        }
      }
      let L = null;
      !j || I.isDev || v || (L = "/index" === (L = O) ? "/" : L);
      let J = !0 === I.isDev || !j,
        N = j && !J;
      Y &&
        T &&
        (0, r.setManifestsSingleton)({
          page: Q,
          clientReferenceManifest: T,
          serverActionsManifest: Y,
        });
      let b = A.method || "GET",
        X = (0, t.getTracer)(),
        x = X.getActiveScopeSpan(),
        F = !!(null == H ? void 0 : H.isWrappedByNextServer),
        K = !!(0, e.getRequestMeta)(A, "minimalMode"),
        k =
          (0, e.getRequestMeta)(A, "incrementalCache") || (await I.getIncrementalCache(A, f, R, K));
      ...
      let U = {
          ...
          renderOpts: {
            experimental: {
              authInterrupts: !!f.experimental.authInterrupts,
              useCacheTimeout: f.experimental.useCacheTimeout,
            },
            cacheComponents: !!f.cacheComponents,
            validationLevel: f.experimental.instantInsights.validationLevel,
            supportsDynamicResponse: J,
            incrementalCache: k,
            hmrRefreshHash: (0, e.getRequestMeta)(A, "hmrRefreshHash"),
            cacheLifeProfiles: f.cacheLife,
            staticPageGenerationTimeout: f.staticPageGenerationTimeout,
            waitUntil: P.waitUntil,
            onClose: (A) => {
              w.on("close", A);
            },
            onAfterTaskError: void 0,
            onInstrumentationRequestError: (w, D, P, e) => I.onRequestError(A, w, P, e, H),
          },
          sharedContext: { buildId: d, deploymentId: M },
        },
        m = new o.NodeNextRequest(A),
        q = new o.NodeNextResponse(w),
        z = i.NextRequestAdapter.fromNodeNextRequest(m, (0, i.signalFromNodeResponse)(w)),
        W = async ({ previousCacheEntry: D }) => {
          try {
            if (!K && h && y && !D)
              return (
                (w.statusCode = 404),
            ...
            let e = await I.handle(z, U);
            A.fetchMetrics = U.renderOpts.fetchMetrics;
            let t = U.renderOpts.pendingWaitUntil;
            t && P.waitUntil && (P.waitUntil(t), (t = void 0));
            let r = U.renderOpts.collectedTags;
            if (!j) return (await (0, B.sendResponse)(m, q, e, t), null);
            {
              let A = await e.blob(),
                w = (0, s.toNodeOutgoingHttpHeaders)(e.headers);
              (r && (w[u.NEXT_CACHE_TAGS_HEADER] = r),
                !w["content-type"] && A.type && (w["content-type"] = A.type));
              let D =
                  void 0 !== U.renderOpts.collectedRevalidate &&
                  !(U.renderOpts.collectedRevalidate >= u.INFINITE_CACHE) &&
                  U.renderOpts.collectedRevalidate,
                P =
                  void 0 === U.renderOpts.collectedExpire ||
                  U.renderOpts.collectedExpire >= u.INFINITE_CACHE
                    ? !1 !== D && D > 0
                      ? f.expireTime
                      : void 0
        ...
        Z = async (e, r) => {
          try {
            ...
            if (!j) return;
            if (
              (null == e || null == (a = e.value) ? void 0 : a.kind) !== c.CachedRouteKind.APP_ROUTE
            )
              throw Object.defineProperty(
                Error(
                  `Invariant: app-route received invalid cache entry ${null == e || null == (o = e.value) ? void 0 : o.kind}`,
                ),
                "__NEXT_ERROR_CODE",
            ...
            (K ||
              w.setHeader(
                "x-nextjs-cache",
                h ? "REVALIDATED" : e.isMiss ? "MISS" : e.isStale ? "STALE" : "HIT",
              ),
              v &&
                w.setHeader(
                  "Cache-Control",
            ...
            let t = (0, s.fromNodeOutgoingHttpHeaders)(e.value.headers);
            ((K && j) || t.delete(u.NEXT_CACHE_TAGS_HEADER),
              !e.cacheControl ||
                w.getHeader("Cache-Control") ||
                t.get("Cache-Control") ||
                t.set("Cache-Control", (0, l.getCacheControlHeader)(e.cacheControl)),
              await (0, B.sendResponse)(
                m,
                q,
                new Response(e.value.body, { headers: t, status: e.value.status || 200 }),
              ));
            return;
          } catch (w) {
            if (
              ...
              throw w;
            await (0, B.sendResponse)(m, q, new Response(null, { status: 500 }));
            return;
          } finally {
            (() => {
              if (!e) return;
              let A = w.statusCode;
              (e.setAttributes({ "http.status_code": A, "next.rsc": !1 }),
                A &&
                  A >= 500 &&
                  (e.setStatus({ code: t.SpanStatusCode.ERROR }),
                  e.setAttribute("error.type", A.toString())));
              let D = X.getRootSpanAttributes();
              if (!D) return;
              if (D.get("next.span_type") !== g.BaseServerSpan.handleRequest)
                return console.warn(
                  `Unexpected root span type '${D.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`,
                );
              let P = D.get("next.route") || S,
                a = `${b} ${P}`;
              (e.setAttributes({ "next.route": P, "http.route": P, "next.span_name": a }),
                e.updateName(a),
                r && r !== e && (r.setAttribute("http.route", P), r.updateName(a)));
            })();
          }
        };
      if (F && x) await Z(x, void 0);
      else {
        let w = X.getActiveScopeSpan();
        await X.withPropagatedContext(
          A.headers,
          () =>
            X.trace(
              g.BaseServerSpan.handleRequest,
              {
                ...
                attributes: { "http.method": b, "http.target": A.url },
              },
              (A) => Z(A, w),
            ),
          void 0,
    ...
    A.s([
      ...
      0,
      function () {
        return (0, P.patchFetch)({ workAsyncStorage: Q, workUnitAsyncStorage: E });
      },
      "routeModule",
      0,
      I,
...
//# sourceMappingURL=_0uxp3uh._.js.map

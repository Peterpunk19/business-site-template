module.exports = [
  ...
  (a, b, c) => {
    ...
    let f = 0,
      ...
      h = 0;
    function i(a, b) {
      return "performance" in globalThis && (process.env.NEXT_OTEL_PERFORMANCE_PREFIX || b)
        ? {
            require: (...b) => {
  ...
  (a, b, c) => {
    ...
    let l = "performance" in globalThis && process.env.NEXT_OTEL_PERFORMANCE_PREFIX;
    async function m(a, b, c) {
      try {
        ...
        await a.pipeTo(m, { signal: k.signal });
      } catch (a) {
        if (k(a)) return;
        throw Object.defineProperty(
      ...
      try {
        ...
        (b.once("close", () => {
          ...
          a.on("data", (c) => {
            if (!f) {
              if (
                ((f = !0), "performance" in globalThis && process.env.NEXT_OTEL_PERFORMANCE_PREFIX)
              ) {
                let a = (0, j.getClientComponentLoaderMetrics)();
                a &&
                  performance.measure(
            ...
            let d = b.write(c);
            ("flush" in b && "function" == typeof b.flush && b.flush(),
              d ||
                (a.pause(),
                b.once("drain", () => {
                  a.resume();
          ...
          a.on("end", async () => {
            (c && (await c), b.writableFinished || b.end(), l.resolve());
          }),
          a.on("error", (a) => {
            (k(a) || b.destroy(a), l.resolve());
          }),
          await l.promise);
      } catch (a) {
        if (k(a)) return;
  ...
  (a, b, c) => {
    ...
    class h {
      static #a = (this.EMPTY = new h(null, { metadata: {}, contentType: null }));
      static fromStatic(a, b) {
        return new h(a, { metadata: {}, contentType: b });
      }
      ...
      async pipeToNodeResponse(a) {
        ...
        !Array.isArray(this.response) &&
        g(this.response)
          ? await (0, e.pipeNodeReadableToNodeResponse)(this.response, a, this.waitUntil)
  ...
  (a, b, c) => {
    ...
    class p {
      ...
      async get(a, b, c) {
        ...
        if (this.minimal_mode && (null == n ? void 0 : n.cacheControl)) {
          let b = o(a, m);
          this.cache.set(b, { entry: n, expiresAt: Date.now() + this.ttl });
        }
      ...
      async handleRevalidate(a, b, c, d, e, f, g) {
        try {
          ...
          if (!h) return null;
          let i = await (0, j.fromResponseCacheEntry)({ ...h, isMiss: !f });
          return (
            i.cacheControl &&
              !this.minimal_mode &&
  ...
  (a, b, c) => {
    ...
    function f(a) {
      ...
      return (
        ...
        d &&
          (e.body && d.register(e, new WeakRef(e.body)),
          f.body && d.register(f, new WeakRef(f.body))),
        [e, f]
      );
    }
  ...
  (a, b, c) => {
    "use strict";
    (Object.defineProperty(c, "__esModule", { value: !0 }),
      Object.defineProperty(c, "encodeCacheTag", {
        enumerable: !0,
        get: function () {
          return f;
        },
    ...
    let d = /[^\t\x20-\x7e]/,
      e = /[^\t\x20-\x7e]+/g;
    function f(a) {
      return d.test(a) ? a.replace(e, (a) => encodeURIComponent(a)) : a;
    }
  },
  26095,
  (a, b, c) => {
    ...
    a.r(31382);
    let q = a.r(86465),
      r = Symbol.for("next-patch");
    function s(a, b) {
      try {
        let c;
        if (!1 === a || a === 1 / 0) c = j.INFINITE_CACHE;
      ...
      for (let e = 0; e < a.length; e++) {
        ...
        if (
          ("string" != typeof f
            ...
            : f.length > j.NEXT_CACHE_TAG_MAX_LENGTH
              ? d.push({ tag: f, reason: `exceeded max length of ${j.NEXT_CACHE_TAG_MAX_LENGTH}` })
              : c.push((0, q.encodeCacheTag)(f)),
          c.length > j.NEXT_CACHE_TAG_MAX_ITEMS)
        ) {
          console.warn(
    ...
    function u(a, b, c) {
      ...
      if (
        ...
        (0, g.isRequestInsightsEnabled)())
      ) {
        let b = (0, h.getRequestInsightsIdentity)(),
          c = (null == b ? void 0 : b.requestId) ?? a.requestId;
        c &&
          (0, g.recordRequestInsightFetch)(
            {
              requestId: c,
              kind: null == b ? void 0 : b.kind,
              htmlRequestId: (null == b ? void 0 : b.htmlRequestId) ?? a.htmlRequestId,
              route: a.route,
            },
            {
              url: d.url,
              ...
              statusCode: d.status,
              startTime: d.start,
              durationMs: d.end - d.start,
              cacheStatus: d.cacheStatus,
              cacheReason: d.cacheReason,
              index: d.idx,
            },
          );
      }
    ...
    async function v(a, b, c, d, e, f) {
      ...
      return (
        c && (await d.set(b, { kind: o.CachedRouteKind.FETCH, data: h, revalidate: e }, c)),
        await f(),
        new Response(g, { headers: a.headers, status: a.status, statusText: a.statusText })
      );
    }
    async function w(a, b, c, d, e, f, g, h, i, j) {
      let [k, l] = (0, p.cloneResponse)(b),
        m = k
          .arrayBuffer()
          .then(async (a) => {
            let b = Buffer.from(a),
            ...
            (null == f || f.set(c, h),
              d && (await e.set(c, { kind: o.CachedRouteKind.FETCH, data: h, revalidate: g }, d)));
          })
          .catch((a) => {
      ...
      return (
        ...
        (q[n] = r
          .then(() => m)
          .finally(() => {
            (null == q ? void 0 : q[n]) && delete q[n];
          })),
        l
      );
    }
    function x(a, { workAsyncStorage: b, workUnitAsyncStorage: c }) {
      let d = async function (d, e) {
        var g, h;
        let m;
        try {
          (((m = new URL(d instanceof Request ? d.url : d)).username = ""), (m.password = ""));
        } catch {
          m = void 0;
        }
        let q = (null == m ? void 0 : m.href) ?? "",
          r = (null == e || null == (g = e.method) ? void 0 : g.toUpperCase()) || "GET",
          x = (null == e || null == (h = e.next) ? void 0 : h.internal) === !0,
          y = "1" === process.env.NEXT_OTEL_FETCH_DISABLED,
          A = x ? void 0 : performance.timeOrigin + performance.now(),
          B = b.getStore(),
          C = c.getStore(),
          D = C ? (0, n.getCacheSignal)(C) : null;
        D && D.beginRead();
        let E = (0, i.getTracer)().trace(
          x ? f.NextNodeServerSpan.internalFetch : f.AppRenderSpan.fetch,
          {
            hideSpan: y,
            kind: i.SpanKind.CLIENT,
            spanName: ["fetch", r, q].filter(Boolean).join(" "),
            attributes: {
              "http.url": q,
              "http.method": r,
          ...
          async (b) => {
            ...
            if (f && Array.isArray(H)) {
              let a = f.tags ?? (f.tags = []);
              for (let b of H) a.includes(b) || a.push(b);
            }
            let I = null == C ? void 0 : C.implicitTags,
              J = B.fetchCache;
            C && "unstable-cache" === C.type && (J = "force-no-store");
            let K = !!B.isUnstableNoStore,
              L = y("cache"),
              M = "";
            "string" == typeof L &&
              void 0 !== G &&
              (("force-cache" === L && 0 === G) || ("no-store" === L && (G > 0 || !1 === G))) &&
              ((g = `Specified "cache: ${L}" and "revalidate: ${G}", only one should be specified.`),
              (L = void 0),
              (G = void 0));
            let N =
                "no-cache" === L ||
                ...
                "force-no-store" === J ||
                "only-no-store" === J,
              O = !J && !L && !G && B.forceDynamic;
            ("force-cache" === L && void 0 === G ? (G = !1) : (N || O) && (G = 0),
              ("no-cache" === L || "no-store" === L) && (M = `cache: ${L}`),
              (n = s(G, B.route)));
            let P = y("headers"),
              Q = "function" == typeof (null == P ? void 0 : P.get) ? P : new Headers(P || {}),
              R = Q.get("authorization") || Q.get("cookie"),
              S = !["get", "head"].includes(
                (null == (c = y("method")) ? void 0 : c.toLowerCase()) || "get",
              ),
              T = void 0 == J && (void 0 == L || "default" === L) && void 0 == G,
              U = !!((R || S) && (null == f ? void 0 : f.revalidate) === 0),
              V = !1;
            if ((!U && T && (B.isBuildTimePrerendering ? (V = !0) : (U = !0)), T && void 0 !== C))
              switch (C.type) {
                case "prerender":
                case "prerender-runtime":
                case "prerender-client":
                  return (
                    D && (D.endRead(), (D = null)),
                    (0, l.makeDynamicHangingPromise)(C.renderSignal, B.route, "fetch()")
                  );
              }
            switch (J) {
              case "force-no-store":
                ...
                break;
              case "only-no-store":
                if ("force-cache" === L || (void 0 !== n && n > 0))
                  throw Object.defineProperty(
                    Error(
                      `cache: 'force-cache' used on fetch for ${q} with 'export const fetchCache = 'only-no-store'`,
                    ),
                    "__NEXT_ERROR_CODE",
              ...
              case "only-cache":
                if ("no-store" === L)
                  throw Object.defineProperty(
                    Error(
                      `cache: 'no-store' used on fetch for ${q} with 'export const fetchCache = 'only-cache'`,
                    ),
                    "__NEXT_ERROR_CODE",
              ...
              case "force-cache":
                (void 0 === G || 0 === G) &&
                  ((M = "fetchCache = force-cache"), (n = j.INFINITE_CACHE));
            }
            if (
              (void 0 === n
                ? "default-cache" !== J || K
                  ? "default-no-store" === J
                    ? ((n = 0), (M = "fetchCache = default-no-store"))
                    : K
                      ? ((n = 0), (M = "noStore call"))
                      : U
                        ? ((n = 0), (M = "auto no cache"))
                        : ((M = "auto cache"), (n = f ? f.revalidate : j.INFINITE_CACHE))
                  : ((n = j.INFINITE_CACHE), (M = "fetchCache = default-cache"))
                : M || (M = `revalidate: ${n}`),
              !(B.forceStatic && 0 === n) && !U && f && n < f.revalidate)
            ) {
              if (0 === n) {
                if (C)
                  switch (C.type) {
                ...
                (0, k.markCurrentScopeAsDynamic)(B, C, `revalidate: 0 fetch ${d} ${B.route}`);
              }
              f && F === n && (f.revalidate = n);
            }
            let W = "number" == typeof n && n > 0,
              { incrementalCache: X } = B,
              Y = !1;
            if (C)
              switch (C.type) {
                case "request":
                case "cache":
                case "private-cache":
                  ((Y = C.isHmrRefresh ?? !1), (i = C.serverComponentsHmrCache));
              }
            if (X && (W || i))
              try {
                h = await X.generateCacheKey(q, r ? d : e);
              } catch (a) {
                console.error("Failed to generate cache key for", d, a);
              }
            let Z = B.nextFetchId ?? 1;
            B.nextFetchId = Z + 1;
            let $ = () => {},
              _ = async (c, f) => {
                let k = [
                ...
                let l = {
                  ...e,
                  next: { ...(null == e ? void 0 : e.next), fetchType: "origin", fetchIdx: Z },
                };
                return a(d, l)
                  .then(async (a) => {
                    if (
                      (!c &&
                        ...
                        u(B, b, {
                          ...
                          url: q,
                          cacheReason: f || M,
                          cacheStatus: 0 === n || f ? "skip" : "miss",
                          cacheWarning: g,
                          status: a.status,
                          method: l.method || "GET",
                        }),
                      200 === a.status && X && h && (W || i))
                    ) {
                      let b = n >= j.INFINITE_CACHE ? j.CACHE_ONE_YEAR_SECONDS : n,
                        c = W
                          ? {
                              fetchCache: !0,
                              fetchUrl: q,
                      ...
                      switch (null == C ? void 0 : C.type) {
                        ...
                        case void 0:
                          return w(B, a, h, c, X, i, b, d, $, y("signal"));
                      }
                    }
                    return (await $(), a);
                  })
            ...
            if (h && X) {
              let a;
              if ((Y && i && ((a = i.get(h)), (ab = !0)), W && !a)) {
                $ = await X.lock(h);
                let b = B.isOnDemandRevalidate
                  ? null
                  : await X.get(h, {
                      kind: o.IncrementalCacheKind.FETCH,
                      revalidate: n,
                      fetchUrl: q,
                      fetchIdx: Z,
                      tags: H,
                ...
                if (
                  (b ? await $() : (m = "cache-control: no-cache (hard refresh)"),
                  (null == b ? void 0 : b.value) && b.value.kind === o.CachedRouteKind.FETCH)
                )
                  if (B.isStaticGeneration && b.isStale) aa = !0;
                  else {
                    if (b.isStale && ((B.pendingRevalidates ??= {}), !B.pendingRevalidates[h])) {
                      let a = _(!0)
                        .then(async (a) => ({
                        ...
                        .finally(() => {
                          ((B.pendingRevalidates ??= {}), delete B.pendingRevalidates[h || ""]);
                        });
                      (a.catch(console.error), (B.pendingRevalidates[h] = a));
                    }
                    a = b.value.data;
                  }
              }
            ...
            if (B.isStaticGeneration && e && "object" == typeof e) {
              ...
              if ("no-store" === a) {
                ...
                (0, k.markCurrentScopeAsDynamic)(B, C, `no-store fetch ${d} ${B.route}`);
              }
              let b = "next" in e,
                { next: c = {} } = e;
                ...
                if (0 === c.revalidate) {
                  if (C)
                    switch (C.type) {
                      ...
                      case "prerender-runtime":
                      case "validation-client":
                        return (0, l.makeDynamicHangingPromise)(C.renderSignal, B.route, "fetch()");
                    }
                  (0, k.markCurrentScopeAsDynamic)(B, C, `revalidate: 0 fetch ${d} ${B.route}`);
                }
                (B.forceStatic && 0 === c.revalidate) || (f.revalidate = c.revalidate);
              }
              b && delete e.next;
            }
            if (!h || !aa) return _(!1, m);
            {
              let a = h;
              ...
              let c = _(!0, m).then(p.cloneResponse);
              return (
                (b = c
                  .then(async (a) => {
                    let b = a[0];
    ...
    function y(a) {
      ...
      let b = (0, m.createDedupeFetch)(globalThis.fetch);
      globalThis.fetch = x(b, a);
    }
    let z = null;
  },
  76391,
  (a, b, c) => {
    ...
    var r =
      ...
      x =
        ...
        (j.waitShellReady = "AppRender.waitShellReady"),
        (j.renderToNodeFizzStream = "AppRender.renderToNodeFizzStream"),
        (j.instantInsights = "AppRender.instantInsights"),
        (j.instantInsightsPrepareValidation = "AppRender.instantInsights.prepareValidation"),
        (j.instantInsightsRunValidation = "AppRender.instantInsights.runValidation"),
        j),
  ...
  (a, b, c) => {
    ...
    var d = {
      ...
      isRequestInsightsEnabled: function () {
        return g.isRequestInsightsEnabled;
      },
    ...
    let f = a.r(95683),
      g = a.r(68342),
      h = Symbol.for("@next/request-insights-store"),
      i = new Set([
        "http.method",
        "http.route",
        "http.status_code",
    ...
    class k {
      recordSpan(a) {
        ...
        let g = this.getOrCreateRequest(
            {
              requestId: a.requestId,
              kind: a.requestInsightKind,
              htmlRequestId: a.htmlRequestId,
              route: a.route,
              url: a.url,
            },
            a.startTime ?? a.timestamp,
          ),
          h = a.startTime ?? a.timestamp;
        ((g.htmlRequestId = a.htmlRequestId ?? g.htmlRequestId),
          (g.route = g.route ?? a.route),
          (g.url = g.url ?? t(a.url)),
          this.updateTiming(
            g,
            h,
            a.durationMs,
            (null == (b = a.attributes) ? void 0 : b["next.span_type"]) ===
              "BaseServer.handleRequest",
          ),
          (g.status =
            "error" === g.status || "error" === a.status
              ? "error"
              : "ok" === a.status
                ? "ok"
                : g.status),
          g.spans.push({
            ...
            links:
              null == (c = a.links)
                ? void 0
                : c.map((a) => ({ ...a, attributes: s(a.attributes) })),
            events:
              null == (d = a.events)
                ? void 0
                : d.map((a) => ({ ...a, attributes: s(a.attributes) })),
            error: a.error,
          }));
        let i =
          (f = (e = a).attributes) && "AppRender.fetch" === f["next.span_type"]
            ? {
                url: t(u(f["http.url"]) ?? e.url),
                method: u(f["http.method"]),
                statusCode: v(f["http.status_code"]),
                startTime: e.startTime ?? e.timestamp,
                durationMs: e.durationMs,
                cacheStatus: u(f["next.fetch.cache_status"]),
                cacheReason: u(f["next.fetch.cache_reason"]),
                index: v(f["next.fetch.idx"]),
              }
            : null;
        (i && this.recordFetchForInsight(g, i), this.notify(g));
      }
      recordFetch(a, b) {
        if (!a.requestId) return;
        let c = b.startTime ?? performance.timeOrigin + performance.now(),
          d = this.getOrCreateRequest(a, c);
        (this.updateTiming(d, c, b.durationMs, !1),
          this.recordFetchForInsight(d, r(b)),
          this.notify(d));
      }
      getSnapshot() {
        return {
          requests: this.requestOrder.map((a) => this.requests.get(a)).filter((a) => void 0 !== a),
        };
      }
      subscribe(a) {
        return (
      ...
      clear() {
        (this.requests.clear(), this.requestTimings.clear(), (this.requestOrder.length = 0));
      }
      updateTiming(a, b, c, d) {
        let e = (0, f.getRequestInsightKey)(a);
        if (d && void 0 !== c) {
          let d = { startTime: b, durationMs: c };
          (this.requestTimings.set(e, d),
            (a.startTime = d.startTime),
            (a.durationMs = d.durationMs));
          return;
        }
        let g = this.requestTimings.get(e);
        if (g) {
          ((a.startTime = g.startTime), (a.durationMs = g.durationMs));
          return;
        }
        let h = b + (c ?? 0),
          i = a.startTime + (a.durationMs ?? 0);
        ((a.startTime = Math.min(a.startTime, b)), (a.durationMs = Math.max(i, h) - a.startTime));
      }
      notify(a) {
        for (let b of this.listeners) b(a);
      }
      getOrCreateRequest(a, b) {
        let c = a.requestId,
          d = (0, f.getRequestInsightKey)({ requestId: c, kind: a.kind }),
          e = this.requests.get(d);
        return (
          e ||
            ((e = {
              requestId: c,
              kind: (0, f.getRequestInsightKind)(a),
              htmlRequestId: a.htmlRequestId ?? c,
              route: a.route,
              url: t(a.url),
              startTime: b,
              status: "pending",
            ...
            this.requests.set(d, e),
            this.requestOrder.push(d),
            this.trim()),
          (e.htmlRequestId = a.htmlRequestId ?? e.htmlRequestId),
          (e.route = e.route ?? a.route),
          (e.url = e.url ?? t(a.url)),
          (e.startTime = Math.min(e.startTime, b)),
          e
        );
      }
      recordFetchForInsight(a, b) {
        a.fetches.some(
          (a) =>
            a.url === b.url &&
            (void 0 !== a.index && void 0 !== b.index
              ? a.index === b.index
              : a.startTime === b.startTime),
        ) || a.fetches.push(r(b));
      }
      trim() {
        for (; this.requestOrder.length > 100;) {
          let a = this.requestOrder.shift();
          a && (this.requests.delete(a), this.requestTimings.delete(a));
        }
      }
      constructor() {
    ...
    function l(a) {
      var b;
      (null == (b = a.attributes) ? void 0 : b["next.span_type"]) !==
        "NextNodeServer.clientComponentLoading" && q().recordSpan(a);
    }
    function m(a, b) {
      q().recordFetch(a, b);
    }
    ...
    function s(a) {
      ...
      for (let [d, e] of Object.entries(a)) {
        var c;
        i.has(d) && (b[d] = "http.url" === d ? ("string" == typeof (c = e) ? (t(c) ?? "") : c) : e);
      }
    ...
    function t(a) {
      ...
      let b = a.startsWith("/");
      try {
        let c = b ? new URL(a, "http://n") : new URL(a);
        for (let a of ((c.username = ""), (c.password = ""), Array.from(c.searchParams.keys())))
          j.test(a) && c.searchParams.set(a, "redacted");
        return b ? `${c.pathname}${c.search}${c.hash}` : c.href;
      } catch {
        return a;
      }
    }
  ...
  (a, b, c) => {
    ...
    let h = "u" > typeof globalThis && globalThis.AsyncLocalStorage;
    function i() {
      return h ? new h() : new g();
    }
    function j(a) {
      return h ? h.bind(a) : g.bind(a);
    }
    function k() {
      return h
        ? h.snapshot()
  ...
  (a, b, c) => {
    ...
    for (var e in d) Object.defineProperty(c, e, { enumerable: !0, get: d[e] });
    let f = a.r(34252),
      g = Symbol.for("@next/request-insights-identity-storage");
    function h() {
      let a = globalThis;
      return (a[g] ??= (0, f.createAsyncLocalStorage)());
    }
    function i(a, b) {
      return h().run(a, b);
    }
  ...
  (a, b, c) => {
    ...
    function s(a) {
      return "object" == typeof a && null !== a && a instanceof r;
    }
    let t = (a, b) => {
        (s(b) && b.bubble
          ? a.setAttribute("next.bubble", !0)
          : (b && (a.recordException(b), a.setAttribute("error.type", b.name)),
            a.setStatus({ code: o.ERROR, message: null == b ? void 0 : b.message })),
          a.end());
      },
      u = new Map(),
      v = d.createContextKey("next.rootSpanId"),
      w = 0,
      x = {
        set(a, b, c) {
      ...
      y =
        ((e = new (class a {
          getTracerInstance() {
            return n.getTracer("next.js", "0.0.1");
          }
          isOpenTelemetryEnabled() {
            var a, b;
            let c = n.getSpan(l.active());
            if (null == c ? void 0 : c.isRecording()) return !0;
            let d = n.getTracerProvider();
            return (
              !("getDelegate" in d) ||
              (null == d.getDelegate ||
          ...
          runWithDetachedContext(a) {
            return j || this.isOpenTelemetryEnabled() ? l.with(q, a) : a();
          }
          withPropagatedContext(a, b, c, d = !1) {
            let e = l.active();
            if (!j && !this.isOpenTelemetryEnabled() && !n.getSpanContext(e)) return b();
            if (d) {
              let d = m.extract(q, a, c);
              if (n.getSpanContext(d)) return l.with(d, b);
              let f = m.extract(e, a, c);
              return l.with(f, b);
            }
            if (n.getSpanContext(e)) return b();
            let f = m.extract(e, a, c);
            return l.with(f, b);
          }
          trace(...a) {
            let [b, c, d] = a,
              e = !!j || this.isOpenTelemetryEnabled(),
              f = k(),
              g = (null == f ? void 0 : f.isLocalSpanRecordingEnabled()) ?? !1;
            if (!e && !g) return "function" == typeof c ? c() : d();
            let { fn: m, options: n } =
                "function" == typeof c ? { fn: c, options: {} } : { fn: d, options: { ...c } },
              o = n.spanName ?? b,
              p = n.parentSpan ?? this.getActiveScopeSpan(),
              r = p && (null == f ? void 0 : f.isOpenTelemetryIsolatedSpan(p)) ? p : void 0,
              s =
                !r && (h.NextVanillaSpanAllowlist.has(b) || "1" === process.env.NEXT_OTEL_VERBOSE);
            if (!(s || (null == f ? void 0 : f.isRequestInsightsEnabled())) || n.hideSpan)
              return m();
            let x = r ? l.active() : this.getSpanContext(p);
            x || (x = (null == l ? void 0 : l.active()) ?? q);
            let y = x.getValue(v),
              z = "number" != typeof y || !u.has(y),
              A = w++;
            return (
              (n.attributes = {
              ...
              l.with(x.setValue(v, A), () =>
                this.runWithActiveSpan(o, n, x, e && s, g, r, (a) => {
                  let c;
                  j &&
                    b &&
                  ...
                  if ((z && u.set(A, new Map(Object.entries(n.attributes ?? {}))), m.length > 1))
                    try {
                      return m(a, (b) => {
                        b ? t(a, b) : a.end();
                      });
          ...
          runWithActiveSpan(a, b, c, d, e, f, g) {
            if (d)
              return this.getTracerInstance().startActiveSpan(a, b, (d) =>
                g(e ? this.createLocalRecordingSpan(a, b, c, d, f) : d),
              );
            let h = this.createLocalRecordingSpan(a, b, c, void 0, f),
              i = k();
            return i.withLocalSpan(h, () =>
              i.isOpenTelemetryIsolatedSpan(h)
                ? g(h)
                : l.with(n.setSpan(l.active(), h), g, void 0, h),
            );
          }
          createLocalRecordingSpan(a, b, c, d, e) {
            let f = (null == e ? void 0 : e.spanContext()) ?? n.getSpanContext(c),
              g = null == d ? void 0 : d.spanContext();
            return k().createLocalSpan({
              name: a,
              attributes: b.attributes,
              links: b.links,
              startTime: b.startTime,
              delegateSpan: d,
              traceId: (null == g ? void 0 : g.traceId) ?? (null == f ? void 0 : f.traceId),
              spanId: null == g ? void 0 : g.spanId,
              parentSpanId: null == f ? void 0 : f.spanId,
          ...
          wrap(...a) {
            ...
            return h.NextVanillaSpanAllowlist.has(c) || "1" === process.env.NEXT_OTEL_VERBOSE
              ? function () {
                  ...
                  {
                    let d = b.getContext().bind(l.active(), g);
                    return b.trace(
                      c,
                      a,
                      (a, b) => (
          ...
          startSpan(...a) {
            let [b, c] = a,
              ...
              e = k(),
              f = d.parentSpan ?? this.getActiveScopeSpan(),
              g = f && (null == e ? void 0 : e.isOpenTelemetryIsolatedSpan(f)) ? f : void 0,
              h = (g ? void 0 : this.getSpanContext(f)) ?? l.active();
            if (!(null == e ? void 0 : e.isLocalSpanRecordingEnabled()))
              return this.getTracerInstance().startSpan(b, d, h);
            let i =
              !g && this.isOpenTelemetryEnabled()
                ? this.getTracerInstance().startSpan(b, d, h)
                : void 0;
            return this.createLocalRecordingSpan(b, d, h, i, g);
          }
          getSpanContext(a) {
            return a ? n.setSpan(l.active(), a) : void 0;
          }
          getRootSpanAttributes() {
            let a = l.active().getValue(v);
            return u.get(a);
          }
          setRootSpanAttribute(a, b) {
            let c = l.active().getValue(v),
              d = u.get(c);
            d && !d.has(a) && d.set(a, b);
          }
          withSpan(a, b) {
            ...
            return (null == c ? void 0 : c.isLocalRecordingSpan(a))
              ? c.withLocalSpan(a, () =>
                  c.isOpenTelemetryIsolatedSpan(a) ? b() : l.with(n.setSpan(l.active(), a), b),
                )
              : l.with(n.setSpan(l.active(), a), b);
          }
        })()),
        () => e);
  },
  ...
  (a, b, c) => {
    ...
    function j() {
      ...
      if (a && b) {
        if (b && !(0, h.isRequestApiAllowedInCurrentPhase)(b))
          throw Object.defineProperty(
            Error(
              `Route ${a.route} used \`io()\` inside \`after()\` while rendering. The \`io()\` function is not allowed in this scope. See more info here: https://nextjs.org/docs/app/api-reference/functions/after`,
            ),
            "__NEXT_ERROR_CODE",
            { value: "E1380", enumerable: !1, configurable: !0 },
          );
        switch (b.type) {
          case "request":
            if (b.asyncApiPromises) return b.asyncApiPromises.io;
            break;
          case "prerender":
          case "prerender-client":
          case "prerender-runtime":
            return (0, f.makeDynamicHangingPromise)(b.renderSignal, a.route, "`io()`");
          case "prerender-ppr":
            (0, g.throwPrerenderPPRRemovedError)();
        }
      }
      return i;
    }
    ((i.status = "fulfilled"), (i.value = void 0));
  },
  32621,
  (a, b, c) => {
    "use strict";
  ...
  (a, b, c) => {
    ...
    let { env: g, stdout: h } = (null == (d = globalThis) ? void 0 : d.process) ?? {},
      i =
        g &&
        !g.NO_COLOR &&
        (g.FORCE_COLOR || ((null == h ? void 0 : h.isTTY) && !g.CI && "dumb" !== g.TERM)),
      j = (a, b, c, d) => {
  ...
  (a, b, c) => {
    ...
    let f = "rsc",
      ...
      l = "next-url",
      m = "text/x-component",
      n = "next-instant-navigation-testing",
      o = [f, h, i, k, j],
      p = "_rsc",
  ...
  (a, b, c) => {
    ...
    function i(a, b, c, d) {
      return (void 0 === a || "0" === a) && void 0 === b && void 0 === c && void 0 === d
        ? null
        : [a ?? "0", h(b), h(c), h(d)].join(",");
    }
    async function j(a) {
      var b = new Uint8Array(
        await globalThis.crypto.subtle.digest("SHA-256", g.encode(a)),
      ).subarray(0, 12);
      let c = "";
  ...
  (a, b, c) => {
    ...
    async function v(b) {
      let c,
        d = [];
      for await (let e of b instanceof (c = a.r(81111).Readable) ? b : c.fromWeb(b))
        d.push("string" == typeof e ? Buffer.from(e) : e);
      return Buffer.concat(d);
    }
    async function w(b) {
      return b instanceof a.r(81111).Readable ? v(b) : u(b);
    }
    async function x(a) {
      return Buffer.concat(await t(a));
    }
        ...
        async transform(d, e) {
          ...
          if (b) {
            ...
            if (-1 !== a) {
              ...
              b = !0;
            } else (f && e.enqueue(p.encode(f)), e.enqueue(d), (b = !0));
          }
        },
        async flush(b) {
          if (c) {
    ...
    async function D() {
      let a = await (0, n.computeCacheBustingSearchParam)("1", "/_full", void 0, void 0),
        b = `${m.NEXT_RSC_UNION_QUERY}=${a}`,
        c = `<script>__NEXT_CLIENT_RESUME=fetch(location.pathname+'?${b}',{credentials:'same-origin',headers:{'${m.RSC_HEADER}': '1','${m.NEXT_ROUTER_PREFETCH_HEADER}': '1','${m.NEXT_ROUTER_SEGMENT_PREFETCH_HEADER}': '/_full'}})</script>`,
        d = !1;
      return new TransformStream({
        transform(a, b) {
          if (d) return void b.enqueue(a);
          let e = (0, k.indexOfUint8Array)(a, j.ENCODED_TAGS.CLOSED.HEAD);
          if (-1 === e) return void b.enqueue(a);
          let f = p.encode(c),
            g = new Uint8Array(a.length + f.length);
          (g.set(a.slice(0, e)),
            g.set(f, e),
            g.set(a.slice(e), e + f.length),
            b.enqueue(g),
            (d = !0));
        },
      });
      ...
      return new TransformStream({
        transform(d, e) {
          if ((e.enqueue(d), !c)) {
            let d;
            ((c = !0),
              (b = d = new h.DetachedPromise()),
              (0, i.scheduleImmediate)(() => {
                try {
                  e.enqueue(p.encode(a));
                } catch {
                } finally {
                  ((b = void 0), d.resolve());
                }
        ...
        flush(d) {
          if (b) return b.promise;
          c || d.enqueue(p.encode(a));
        },
      });
    }
    function F(a, b) {
    ...
    function I(a) {
      ...
      return new TransformStream({
        transform(c, d) {
          ...
          let e = (0, k.indexOfUint8Array)(c, j.ENCODED_TAGS.OPENING.HTML);
          if (-1 === e) return void d.enqueue(c);
          let f = e + j.ENCODED_TAGS.OPENING.HTML.length,
            g = ` data-dpl-id="${a}"`,
            h = p.encode(g),
            i = new Uint8Array(c.length + h.length);
          (i.set(c.subarray(0, f)),
            i.set(h, f),
            i.set(c.subarray(f), f + h.length),
            d.enqueue(i),
            (b = !0));
        },
      });
...
Read more at https://nextjs.org/docs/messages/missing-root-layout-tags"
    ...
    async function L(
      a,
      {
        ...
        deploymentId: e,
        getServerInsertedHTML: f,
        getServerInsertedMetadata: g,
        validateRootLayout: h,
      },
    ) {
      let j = b ? b.split(G, 1)[0] : null;
      return (
    ...
    async function N(
      ...
      return K(a, [z(), e ? I(e) : null, C(c), B(d), F(b, !0), H()]);
    }
    async function O(
      a,
      {
      ...
      return K(a, [z(), e ? I(e) : null, C(c), await D(), B(d), F(b, !0), H()]);
    }
    async function P(
      a,
      {
      ...
      return K(a, [z(), f ? I(f) : null, C(d), B(e), F(c, b), H()]);
    }
    function Q() {
      return r(G);
    }
  ...
  (a, b, c) => {
    "use strict";
    (Object.defineProperty(c, "__esModule", { value: !0 }),
      Object.defineProperty(c, "validateAndNormalizeCacheLifeProfile", {
        enumerable: !0,
        get: function () {
          return e;
        },
    ...
    function e(a, b) {
      let c = { ...a };
      for (let e of ["stale", "revalidate", "expire"]) {
        let f = (function (a, b, c) {
          if (void 0 !== b) {
            ...
            if ("number" != typeof b)
              throw Object.defineProperty(
                Error(`The ${a} option must be a number of seconds.`),
                "__NEXT_ERROR_CODE",
                { value: "E1414", enumerable: !1, configurable: !0 },
              );
            if (b === 1 / 0) return d.INFINITE_CACHE;
            if (!Number.isFinite(b))
              throw Object.defineProperty(
                Error(
                  "config" === c.kind
                    ? `Invalid "cacheLife.${c.profileName}.${a}" provided, expected a finite number of seconds or Infinity, received ${b}`
                    : `Invalid \`cacheLife()\` option "${a}" provided, expected a finite number of seconds or Infinity, received ${b}.`,
                ),
                "__NEXT_ERROR_CODE",
      ...
      if (void 0 !== c.revalidate && void 0 !== c.expire && c.revalidate > c.expire)
        throw Object.defineProperty(
          Error(
  ...
  (a, b, c) => {
    ...
    function q(a, b) {
      return (
        b
          ? "object" == typeof b &&
            (b = (0, p.validateAndNormalizeCacheLifeProfile)(b, { kind: "inline" }))
          : console.warn(
        ...
        u([(0, o.encodeCacheTag)(a)], `revalidateTag ${a}`, b)
      );
    }
    function r(a) {
      ...
      return u([(0, o.encodeCacheTag)(a)], `updateTag ${a}`, void 0);
    }
    function s() {
    ...
    function t(a, b) {
      ...
      let c = `${h.NEXT_CACHE_IMPLICIT_TAG_ID}${(0, o.encodeCacheTag)((0, n.removeTrailingSlash)(a))}`;
      b
        ? (c += `${c.endsWith("/") ? "" : "/"}${b}`)
      ...
      return (
        ...
        u(d, `revalidatePath ${a}`)
      );
    }
    function u(a, b, c) {
      let d = i.workAsyncStorage.getStore();
      if (!d || !d.incrementalCache)
        throw Object.defineProperty(
          Error(`Invariant: static generation store missing in ${b}`),
          "__NEXT_ERROR_CODE",
          { value: "E263", enumerable: !1, configurable: !0 },
        );
      let e = j.workUnitAsyncStorage.getStore();
      if (e) {
        if ("render" === e.phase)
          throw Object.defineProperty(
            Error(
              `Route ${d.route} used "${b}" during render which is unsupported. To ensure revalidation is performed consistently it must always happen outside of renders and cached functions. See more info here: https://nextjs.org/docs/app/building-your-application/rendering/static-and-dynamic#dynamic-rendering`,
            ),
            "__NEXT_ERROR_CODE",
        ...
        switch (e.type) {
          ...
          case "private-cache":
            throw Object.defineProperty(
              Error(
                `Route ${d.route} used "${b}" inside a "use cache" which is unsupported. To ensure revalidation is performed consistently it must always happen outside of renders and cached functions. See more info here: https://nextjs.org/docs/app/building-your-application/rendering/static-and-dynamic#dynamic-rendering`,
              ),
              "__NEXT_ERROR_CODE",
          ...
          case "unstable-cache":
            throw Object.defineProperty(
              Error(
                `Route ${d.route} used "${b}" inside a function cached with "unstable_cache(...)" which is unsupported. To ensure revalidation is performed consistently it must always happen outside of renders and cached functions. See more info here: https://nextjs.org/docs/app/building-your-application/rendering/static-and-dynamic#dynamic-rendering`,
              ),
              "__NEXT_ERROR_CODE",
          ...
          case "generate-static-params":
            throw Object.defineProperty(
              Error(
                `Route ${d.route} used "${b}" inside \`generateStaticParams\` which is unsupported. To ensure revalidation is performed consistently it must always happen outside of renders and cached functions. See more info here: https://nextjs.org/docs/app/building-your-application/rendering/static-and-dynamic#dynamic-rendering`,
              ),
              "__NEXT_ERROR_CODE",
              { value: "E1127", enumerable: !1, configurable: !0 },
            );
          case "prerender":
          case "prerender-runtime":
            let a = Object.defineProperty(
              Error(`Route ${d.route} used ${b} without first calling \`await connection()\`.`),
              "__NEXT_ERROR_CODE",
              { value: "E406", enumerable: !1, configurable: !0 },
            );
            return (0, f.abortAndThrowOnSynchronousRequestDataAccess)(d.route, b, a, e);
          case "prerender-client":
          case "validation-client":
            throw Object.defineProperty(
          ...
          case "prerender-ppr":
            return (0, f.postponeWithTracking)(d.route, b, e.dynamicTracking);
          case "prerender-legacy":
            e.revalidate = 0;
            let c = Object.defineProperty(
              new k.DynamicServerError(
                `Route ${d.route} couldn't be rendered statically because it used \`${b}\`. See more info here: https://nextjs.org/docs/messages/dynamic-server-error`,
              ),
              "__NEXT_ERROR_CODE",
              { value: "E558", enumerable: !1, configurable: !0 },
            );
            throw ((d.dynamicUsageDescription = b), (d.dynamicUsageStack = c.stack), c);
        }
      }
      for (let b of (d.pendingRevalidatedTags || (d.pendingRevalidatedTags = []), a))
        -1 ===
          d.pendingRevalidatedTags.findIndex(
            (a) =>
              a.tag === b &&
              ("string" == typeof a.profile && "string" == typeof c
                ...
                : "object" == typeof a.profile && "object" == typeof c
                  ...
                  : a.profile === c),
          ) && d.pendingRevalidatedTags.push({ tag: b, profile: c });
      let g =
        c && "object" == typeof c
          ? c
          : c && "string" == typeof c && (null == d ? void 0 : d.cacheLifeProfiles[c])
            ? d.cacheLifeProfiles[c]
            : void 0;
      (c && (null == g ? void 0 : g.expire) !== 0) ||
        (d.pathWasRevalidated = m.ActionDidRevalidateStaticAndDynamic);
    }
  },
  1247,
  (a, b, c) => {
  ...
  (a, b, c) => {
    "use strict";
    (Object.defineProperty(c, "__esModule", { value: !0 }),
      Object.defineProperty(c, "throwPrerenderPPRRemovedError", {
        enumerable: !0,
        get: function () {
          return e;
        },
    ...
    function e() {
      throw Object.defineProperty(
        ...
        "__NEXT_ERROR_CODE",
        { value: "E1158", enumerable: !1, configurable: !0 },
      );
    }
  },
  71632,
  (a, b, c) => {
    ...
    async function j(a, b, c, e, f, g, i) {
      await b.set(
        c,
        {
          ...
          revalidate: "number" != typeof f ? d.CACHE_ONE_YEAR_SECONDS : f,
        },
    ...
    function k(a, b, c = {}) {
      ...
      let d = c.tags ? (0, e.validateTags)(c.tags, `unstable_cache ${a.toString()}`) : [],
        l = (0, e.validateRevalidate)(c.revalidate, `unstable_cache ${a.name || a.toString()}`),
        m = `${a.toString()}-${Array.isArray(b) && b.join(",")}`;
      return async (...b) => {
        let c = f.workAsyncStorage.getStore(),
          e = g.workUnitAsyncStorage.getStore(),
          k = (null == c ? void 0 : c.incrementalCache) || globalThis.__incrementalCache;
        if (!k)
          throw Object.defineProperty(
        ...
        let n = e ? (0, g.getCacheSignal)(e) : null;
        n && n.beginRead();
        try {
          let f =
              c && e
                ...
                : "",
            n = `${m}-${JSON.stringify(b)}`,
            o = await k.generateSimpleCacheKey(n),
            p = `unstable_cache ${f} ${a.name ? ` ${a.name}` : o}`,
            q = (c ? c.nextFetchId : i) ?? 1,
            r = null == e ? void 0 : e.implicitTags,
            s = {
              type: "unstable-cache",
              phase: "render",
              implicitTags: r,
              draftMode: e && c && (0, g.getDraftModeProviderForCacheScope)(c, e),
              rootParams: void 0,
            };
          if (c) {
            c.nextFetchId = q + 1;
            ...
            if (e)
              switch (e.type) {
                ...
                case "prerender-ppr":
                case "prerender-legacy":
                  "number" == typeof l && (e.revalidate < l || (e.revalidate = l));
                  let i = e.tags;
                  if (null === i) e.tags = d.slice();
            ...
            if (
              ...
              if (e && e.value)
                if (e.value.kind !== h.CachedRouteKind.FETCH)
                  console.error(`Invariant invalid cacheEntry returned for ${n}`);
                else {
                  let f = void 0 !== e.value.data.body ? JSON.parse(e.value.data.body) : void 0;
                  if (e.isStale) {
                    if (
                      (c.pendingRevalidates || (c.pendingRevalidates = {}),
                      !c.pendingRevalidates[n])
                    ) {
                      let e = g.workUnitAsyncStorage
                        .run(s, a, ...b)
                        .then(async (a) => (await j(a, k, o, d, l, q, p), a))
                        .catch((a) => (console.error(`revalidating cache with key: ${n}`, a), f));
                      (c.isStaticGeneration && e.catch(() => {}), (c.pendingRevalidates[n] = e));
                    }
                    if (c.isStaticGeneration) return await c.pendingRevalidates[n];
                  }
                  return f;
                }
            }
            let m = await g.workUnitAsyncStorage.run(s, a, ...b);
            return (
              c.isDraftMode ||
                (c.pendingRevalidates || (c.pendingRevalidates = {}),
                (c.pendingRevalidates[n] = j(m, k, o, d, l, q, p))),
              m
            );
          }
          {
            if (((i += 1), !k.isOnDemandRevalidate)) {
              let a = await k.get(o, {
                kind: h.IncrementalCacheKind.FETCH,
                revalidate: l,
                tags: d,
            ...
            let c = await g.workUnitAsyncStorage.run(s, a, ...b);
            return (await j(c, k, o, d, l, q, p), c);
          }
        } finally {
          n && n.endRead();
        }
    ...
    a.a(async (b, c) => {
      try {
        ...
        async function g() {
          ...
          return (
            a?.user || (0, d.redirect)("/admin/login"),
            "ADMIN" !== a.user.role && (0, d.redirect)("/"),
            a.user
          );
        }
        (([e] = f.then ? (await f)() : f), a.s(["requireAdmin", 0, g]), c());
      } catch (a) {
        c(a);
      }
    }, !1),
...
//# sourceMappingURL=_0r9lkxh._.js.map

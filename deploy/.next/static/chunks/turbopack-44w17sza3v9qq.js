((globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  "object" == typeof document ? document.currentScript : void 0,
  {
    otherChunks: [
      ...
      "static/chunks/2fza_xeidyl42.js",
  ...
  (() => {
    ...
    async function T(e, t, r) {
      ...
      for (let i of ((n = M(e, t, K(r.path))), o)) _.has(i) || _.set(i, n);
      await n;
    }
    P.l = function (e) {
      return T(o.Parent, this.m.id, e);
    };
    let x = Promise.resolve(void 0),
      A = new WeakMap();
    function M(t, r, n) {
      let i = e.loadChunkCached(t, n),
        l = A.get(i);
      if (void 0 === l) {
        let e = A.set.bind(A, i, x);
        ((l = i.then(e).catch((e) => {
          let i;
          switch (t) {
            case o.Runtime:
    ...
    P.L = function (e) {
      var t, r;
      return ((t = o.Parent), (r = this.m.id), M(t, r, e));
    };
    ((P.R = function (e) {
      let t = this.r(e);
      return t?.default ?? t;
    ...
    let q = /[^A-Za-z0-9\-_.!~*'()/]/;
    function K(e, t = r) {
      let o = q.test(e) ? e.split("/").map(encodeURIComponent).join("/") : e;
      return `${t}${o}${n}`;
    }
    function N(e, t) {
      let r,
    ...
    function F(e, t, r) {
      ...
      return (
        o.namespaceObject && o.exports !== o.namespaceObject && b(o.exports, o.namespaceObject),
        o
      );
    }
    function D(t) {
    ...
    function z(e, t, r, n, o) {
      ...
      r.retryAttempts >= 1 ||
      W.get(t) !== r
        ? (W.get(t) === r && W.delete(t), r.reject(n))
        : (r.retryAttempts++,
          setTimeout(
            () => {
              r.resolved || W.get(t) !== r || (o ? o() : ((r.loadingStarted = !1), H(e, t)));
            },
    ...
    function H(e, t) {
      ...
      if (e === o.Runtime) return ((r.loadingStarted = !0), L(t) && r.resolve(), r.promise);
            ...
            let n = () => {
              ...
              return (
                ...
                (o.onerror = () => {
                  ...
                  (o.replaceWith(i), z(e, t, r, void 0, () => i.replaceWith(n())));
                }),
                (o.onload = () => {
                  r.resolve();
                }),
      ...
      async registerChunk(e, t) {
        ...
        if (
          (null != e &&
            ...
            X("string" == typeof e ? K(e) : e.src).resolve()),
          null != t)
        ) {
          for (let e of t.otherChunks) X(K("string" == typeof e ? e : e.path));
          if (
            (await Promise.all(
              t.otherChunks.map((e) => {
                var t;
                return ((t = n), T(o.Runtime, t, e));
              }),
            ),

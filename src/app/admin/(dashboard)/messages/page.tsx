  ...
  return (
    <main className="px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-950 sm:text-3xl">Mensajes</h1>
                ...
                {contactMessages.map((contactMessage) => (
                  ...
                  >
                    ...
                    <div className="mt-4 space-y-1 text-sm text-slate-500">
                      {contactMessage.phone && <p>{contactMessage.phone}</p>}

                      {contactMessage.email && <p className="truncate">{contactMessage.email}</p>}
                    </div>
